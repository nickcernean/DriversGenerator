...
public class CreateLevelSequences {
    ...
    public static void main(String[] args) {
        ...
        LevelSequence levelSequence = new LevelSequence(8, "Gain Input", "",
                LevelSequence.TypeValues.InDecrement, "SET ANLGIN/", "/FADER:-35", "", true, false);
...
//                "DOWNCommand1","DOWNCommand1","DOWNCommand1", false, false);
        ...
        levelSequence.addStringCounter(20, 22, LevelSequence.CountFormat.Decimal, 100, 2, -100, 10);
